...
export function MousePointerIcon({ className = 'h-9 w-9' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function CreditCardIcon({ className = 'h-9 w-9' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function DownloadIcon({ className = 'h-9 w-9' }: IconProps) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
